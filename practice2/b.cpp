...
struct FastIO {
    ...
    FastIO(size_t input_size = 4e7, size_t output_size = 1e7): os(cout) {
...
int64 f(int64 lhs, int64 rhs) { return lhs + rhs; }
using M = Monoid<int64, f>;
template<> constexpr int64 M::unit(0);
